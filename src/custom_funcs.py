...
def base_plot(scale=100, fontsize=12):
    ...
    tax.right_corner_label("entailment", fontsize=fontsize)
...
def get_boundaries(pi, theta):
    ...
    eq1 = y_e + y_c -100
    eq3 = y_n
    eq2 = (np.log(pi[0]) + y_e * np.log(theta[0,0]) + y_n * np.log(theta[0,1]) + y_c * np.log(theta[0,2])) - (np.log(pi[2]) + y_e * np.log(theta[2,0]) + y_n * np.log(theta[2,1]) + y_c * np.log(theta[2,2]))
    dict_ec = solve((eq1,eq2,eq3), (y_e,y_c,y_n))

    # e-n
    eq1 = y_e + y_n -100
    eq3 = y_c
    eq2 = (np.log(pi[0]) + y_e * np.log(theta[0,0]) + y_n * np.log(theta[0,1]) + y_c * np.log(theta[0,2])) - (np.log(pi[1]) + y_e * np.log(theta[1,0]) + y_n * np.log(theta[1,1]) + y_c * np.log(theta[1,2]))
    dict_en = solve((eq1,eq2,eq3), (y_e,y_c,y_n))

    # n-c
    eq1 = y_n + y_c -100
    eq3 = y_e
    eq2 = (np.log(pi[2]) + y_e * np.log(theta[2,0]) + y_n * np.log(theta[2,1]) + y_c * np.log(theta[2,2])) - (np.log(pi[1]) + y_e * np.log(theta[1,0]) + y_n * np.log(theta[1,1]) + y_c * np.log(theta[1,2]))
    dict_nc = solve((eq1,eq2,eq3), (y_e,y_c,y_n))

    # e-n-c
    eq1 = y_e + y_c + y_n - 100
    eq3 = (np.log(pi[0]) + y_e * np.log(theta[0,0]) + y_n * np.log(theta[0,1]) + y_c * np.log(theta[0,2])) - (np.log(pi[1]) + y_e * np.log(theta[1,0]) + y_n * np.log(theta[1,1]) + y_c * np.log(theta[1,2]))
    eq2 = (np.log(pi[0]) + y_e * np.log(theta[0,0]) + y_n * np.log(theta[0,1]) + y_c * np.log(theta[0,2])) - (np.log(pi[2]) + y_e * np.log(theta[2,0]) + y_n * np.log(theta[2,1]) + y_c * np.log(theta[2,2]))
