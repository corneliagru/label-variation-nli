...
def plot_ternary_bounds(tax, pi, theta, bounds_col=CB_color_cycle[7], linestyle='solid'):
    """
    plots the estimated class boundaries for a given pi and theta
    :param linestyle: linestyle of the boundaries
    :param tax: axes object of ternary plot as generated by plot_ternary_axes
    :param pi: pi parameter of multinomial mixture model
    :param theta: theta parameter of multinomial mixture model
    ...
    tax.line(bounds[0], bounds[3], color=bounds_col, linestyle=linestyle)
    tax.line(bounds[1], bounds[3], color=bounds_col, linestyle=linestyle)
    tax.line(bounds[2], bounds[3], color=bounds_col, linestyle=linestyle)
    return tax
